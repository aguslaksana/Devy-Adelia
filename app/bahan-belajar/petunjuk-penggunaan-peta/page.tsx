...
function PetunjukPenggunaanPetaPage() {
	...
	return (
		<div>
			<iframe
				src="https://drive.google.com/file/d/1znI0YrLegldHwJUG88liYEiDxmbibqMj/preview"
...
export default PetunjukPenggunaanPetaPage;
